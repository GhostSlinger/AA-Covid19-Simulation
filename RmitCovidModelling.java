	...
	public static void main(String[] args) {
		...
		if (inputFilename != null) {
			...
			try {
				...
				long StartE = 0;
				long EndE = 0;
				boolean StartVertCount = true;
				boolean StartEdgeCount = true;
				while ((line = reader.readLine()) != null) {
					...
					// otherwise in edge reading phrase
						...
						StartEdgeCount = false;
					}
				}
				EndE = System.nanoTime();
				System.out.println("Time taken to add Vertex: "+ ((double)(EndV - StartV))/Math.pow(10, 9) + " Seconds");
				System.out.println("Time taken to add Edge: "+ ((double)(EndE - StartE))/Math.pow(10, 9) + " Seconds");
			}
